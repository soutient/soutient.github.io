...
```
```yaml
               A good teacher can't tell "and things didn't go as planned", provided their students are well-motivated, of course. Here's a real-life example from my experience as a "Haskell
               formal methods engineer" when I explained this to team members:
               Semantics Lesson: Spatial Thinking. 1) Take a pencil or pen in your left hand. 2) Point to the left end of the pencil with the index finger of your right hand. 3) Say out loud:
